...
/**
 * @description 根据配置信息获取PDF buffer
 * @param name PDF名称
 * @param url 导出服务地址
 * @param host 静态资源地址
 * @param PDF 导出信息
 ...
 * @param {Array} pdfArray pdf buffer数据组成的数组
 * @returns {Buffer} pdf buffer数据
 */
export async function mergePDF(pdfArray) {
    // 创建新的 PDF 文档
    ...
    return new Blob([await pdfDocs.save()], {
