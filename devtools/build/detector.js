(() => {
    ...
    var __webpack_modules__ = {
            ...
            29556: (e, t, n) => {
                ...
                function m() {
                    c.removeAllListeners('shared-data:set'), (g = {});
                }
                (t.initSharedData = d), (t.onSharedDataInit = h), (t.destroySharedData = m);
                let g = {};
                function v(e, t) {
                    p &&
                        s.includes(e) &&
            ...
            58561: (e, t, n) => {
                ...
                function a(e, t = null) {
                    if ((p(), o)) return _(i[e], t);
                    try {
                        return _(JSON.parse(localStorage.getItem(e)), t);
                    } catch (n) {}
                }
                function c(e, t) {
            ...
            22699: (e) => {
                ...
                function v(e, t) {
                    return new Promise(function (n, r) {
                        ...
                        O(e, t, i, { once: !0 }), 'error' !== t && E(e, o, { once: !0 });
                    });
                }
                function E(e, t, n) {
                ...
                Object.defineProperty(s, 'defaultMaxListeners', {
                    ...
                    (s.prototype.once = function (e, t) {
                        return c(t), this.on(e, _(this, e, t)), this;
                    }),
                    (s.prototype.prependOnceListener = function (e, t) {
                        return c(t), this.prependListener(e, _(this, e, t)), this;
                    }),
            ...
            21023: (e) => {
                ...
                var o = {
                    ...
                    relative: function (e, n) {
                        ...
                        for (
                            var c = n.length, l = c - a, u = s < l ? s : l, p = -1, _ = 0;
                            _ <= u;
                            ++_
                        ) {
                            if (_ === u) {
                                if (l > u) {
                                    if (47 === n.charCodeAt(a + _)) return n.slice(a + _ + 1);
                                    if (0 === _) return n.slice(a + _);
                                } else
                                    s > u &&
                                        (47 === e.charCodeAt(r + _) ? (p = _) : 0 === _ && (p = 0));
                                break;
                            }
                            var f = e.charCodeAt(r + _),
                                d = n.charCodeAt(a + _);
                            if (f !== d) break;
                            47 === f && (p = _);
                        }
    ...
    (() => {
        var e = __webpack_require__(33433),
        ...
        function n(e) {
            ...
            function r() {
                ...
                if (o) {
                    let t;
                    return (
                        window.$nuxt && (t = window.$nuxt.$root && window.$nuxt.$root.constructor),
                        void e.postMessage(
                            {
                                devtoolsEnabled:
                                    (t && t.config.devtools) ||
                ...
                if (a) {
                    ...
                    e.postMessage({ devtoolsEnabled: t.config.devtools, vueDetected: !0 }, '*');
                } else
                    n > 0 &&
                        (n--,
                        setTimeout(() => {
        ...
        window.addEventListener('message', (e) => {
            ...
            document instanceof HTMLDocument && (r(n), r(e.R));
    })();
})();
