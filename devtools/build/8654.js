        ...
        78654: (e, t, n) => {
                    ...
                    return (
                        ...
                        (e.prototype._getClient = function () {
                            return (
                                ...
                                this._client ||
                                    ((this._worker = A.j6.createWebWorker({
            ...
            (function (e) {
                ...
                (function (e) {
                    function t(e) {
                        var t = e;
                        return me.objectLiteral(e) && O.is(t.kind) && me.string(t.value);
                    }
                    e.is = t;
                })(N || (N = {})),
                (function (e) {
                ...
                (function (e) {
                    ...
                    function n(t) {
                        var n = t;
                        return (
                            void 0 !== n && o.is(n.range) && (void 0 === n.parent || e.is(n.parent))
                        );
                    }
                    (e.create = t), (e.is = n);
                })(he || (he = {}));
            ...
            (function (e) {
                ...
                (function (e) {
                    e.LATEST = {
                        textDocument: {
                            completion: {
                                completionItem: { documentationFormat: [O.Markdown, O.PlainText] }
                            },
                            hover: { contentFormat: [O.Markdown, O.PlainText] }
                        }
                    };
                })(we || (we = {})),
                (function (e) {
                    ...
                    return (
                        ...
                        (e.prototype.skipWhitespace = function () {
                            var e = this.advanceWhileChar(function (e) {
                                return e === Oe || e === Ne || e === We || e === Pe || e === De;
                            });
                            return e > 0;
                        }),
                ...
                function b() {
                    ...
                    switch (h) {
                        ...
                        case _e.WithinEndTag:
                            ...
                            e = Me('error.closingBracketExpected', 'Closing bracket expected.');
                            break;
            ...
            function et(e, t) {
                ...
                return (Je <= n && n <= Xe) || (Ye <= n && n <= $e) || (Ze <= n && n <= Qe);
            }
            var tt = [
                'area',
                'base',
                    ...
                    (e.prototype._doComplete = function (e, t, n, i) {
                        ...
                        function M(e) {
                            return d === m.getTokenEnd() &&
                                ((R = m.scan()), R === e && m.getTokenOffset() === d)
                                ? m.getTokenEnd()
                                : d;
                        }
                        function L() {
                        ...
                        var R = m.scan();
                        while (R !== be.EOS && m.getTokenOffset() <= d) {
                            switch (R) {
                    ...
                    (e.prototype.doesSupportMarkdown = function () {
                        ...
                        if (!it(this.supportsMarkdown)) {
                            ...
                            this.supportsMarkdown =
                                Array.isArray(i) && -1 !== i.indexOf(O.Markdown);
                        }
            ...
            (function () {
                ...
                (e.prototype.doHover = function (e, t, n, i) {
                    ...
                    var M = g(be.AttributeValue, c.start);
                    if (M) {
                        T = c.tag;
                        var L = Et(e.getText(M)),
                            E = x(c.start, e.offsetAt(M.start));
                        if (E) return m(T, E, L, M);
                    }
                    return null;
                }),
                            ...
                            !(function (e) {
                                (e.joinPath = function (e) {
                                    for (var t = [], n = 1; n < arguments.length; n++)
                                        t[n - 1] = arguments[n];
                                    return e.with({ path: E.join.apply(E, L([e.path], t)) });
                                }),
                                    (e.resolvePath = function (e) {
                                        for (var t = [], n = 1; n < arguments.length; n++)
                                            t[n - 1] = arguments[n];
                                        var i = e.path || '/';
                                        return e.with({ path: E.resolve.apply(E, L([i], t)) });
                                    }),
                ...
                globalAttributes: [
                    {
                        ...
                        description: {
                            kind: 'markdown',
                            value: 'Provides a hint for generating a keyboard shortcut for the current element. This attribute consists of a space-separated list of characters. The browser should use the first one that exists on the computer keyboard Login.'
                        },
                        references: [
                            {
                                name: 'MDN Reference',
            ...
            (function () {
                ...
                (e.prototype.setDataProviders = function (e, t) {
                    var n;
                    (this.dataProviders = []),
                        e && this.dataProviders.push(new at('html5', It)),
            ...
            var Ct = (function () {
                function e(e, t, n) {
                    ...
                    var r = function (e) {
                        ...
                        a = function (e) {
                            A.j6.setModelMarkers(e, i._languageId, []);
                            var t = e.uri.toString(),
                                n = i._listener[t];
                            n && (n.dispose(), delete i._listener[t]);
                        };
                    this._disposables.push(A.j6.onDidCreateModel(r)),
                        this._disposables.push(
                            A.j6.onWillDisposeModel(function (e) {
                                a(e);
                            })
                        ),
                        this._disposables.push(
                            A.j6.onDidChangeModelLanguage(function (e) {
                                a(e.model), r(e.model);
                            })
                        ),
                        this._disposables.push(
                            n.onDidChange(function (e) {
                                A.j6.getModels().forEach(function (e) {
                            ...
                            .then(function (n) {
                                return n.doValidation(e.toString()).then(function (n) {
                                    var i = n.map(function (t) {
                                        ...
                                        r = A.j6.getModel(e);
                                    r && r.getModeId() === t && A.j6.setModelMarkers(r, t, i);
                                });
                            })
                                        ...
                                        a = n.items.map(function (e) {
                                            ...
                                            return (
                                                ...
                                                e.insertTextFormat === j.Snippet &&
                                                    (t.insertTextRules =
                                                        A.Mj.CompletionItemInsertTextRule.InsertAsSnippet),
                                                t
                                            );
                                        });
                ...
                return (
                    (e.prototype.provideHover = function (e, t, n) {
                        ...
                        return this._worker(i)
                            ...
                            .then(function (e) {
                                if (e) return { range: Pt(e.range), contents: Gt(e.contents) };
                            });
                    }),
                    e
                );
            ...
            function Kt(e) {
                var t = A.Mj.DocumentHighlightKind;
                switch (e) {
                    case Z.Read:
                        return t.Read;
                    case Z.Write:
                            ...
                            .then(function (e) {
                                if (e)
                                    return e.map(function (e) {
                                        return { range: Pt(e.range), kind: Kt(e.kind) };
                                    });
                            });
                    }),
                    e
                                    ...
                                    if (e)
                                        return {
                                            links: e.map(function (e) {
                                                return { range: Pt(e.range), url: e.target };
                                            })
                                        };
                                });
                        }),
                    ...
                    return (
                        (e.prototype.provideDocumentFormattingEdits = function (e, t, n) {
                            ...
                            return this._worker(i).then(function (e) {
                                return e.format(i.toString(), null, Zt(t)).then(function (e) {
                    ...
                    return (
                        (e.prototype.provideDocumentRangeFormattingEdits = function (e, t, n, i) {
                            ...
                            return this._worker(r).then(function (e) {
                                return e.format(r.toString(), Dt(t), Zt(n)).then(function (e) {
                                    if (e && 0 !== e.length) return e.map(qt);
                                });
                            });
                        }),
            ...
            function nn(e) {
                if (e && e.changes) {
                    ...
                    for (var n in e.changes)
                        for (var i = A.Sf.parse(n), r = 0, a = e.changes[n]; r < a.length; r++) {
                            var o = a[r];
                            t.push({ resource: i, edit: { range: Pt(o.range), text: o.newText } });
                        }
                    return { edits: t };
                }
            }
                            ...
                            .then(function (e) {
                                if (e)
                                    return e.map(function (e) {
                                        ...
                                        return (
                                            'undefined' !== typeof e.kind && (t.kind = an(e.kind)),
                                            t
                                        );
                                    });
                            });
            ...
            function an(e) {
                switch (e) {
                    case u.Comment:
                        return A.Mj.FoldingRangeKind.Comment;
                    case u.Imports:
                        return A.Mj.FoldingRangeKind.Imports;
                    case u.Region:
                        return A.Mj.FoldingRangeKind.Region;
                }
            }
            var on = (function () {
                function e(e) {
                        ...
                        return this._worker(i)
                            ...
                            .then(function (e) {
                                if (e)
                                    return e.map(function (e) {
                                        var t = [];
                                        while (e) t.push({ range: Pt(e.range) }), (e = e.parent);
                                        return t;
                                    });
                            });
                    }),
            ...
            function sn(e) {
                var t = new z(e),
                    ...
                    i = e.languageId;
                A.Mj.registerCompletionItemProvider(i, new jt(n)),
                    A.Mj.registerHoverProvider(i, new Vt(n)),
                    A.Mj.registerDocumentHighlightProvider(i, new Jt(n)),
                    A.Mj.registerLinkProvider(i, new $t(n)),
                    A.Mj.registerFoldingRangeProvider(i, new rn(n)),
                    A.Mj.registerDocumentSymbolProvider(i, new Yt(n)),
                    A.Mj.registerSelectionRangeProvider(i, new on(n)),
                    A.Mj.registerRenameProvider(i, new tn(n)),
                    'html' === i &&
                        (A.Mj.registerDocumentFormattingEditProvider(i, new Qt(n)),
                        A.Mj.registerDocumentRangeFormattingEditProvider(i, new en(n)),
                        new Ct(i, n, e));
            }
            function ln(e) {
                var t = [],
                ...
                function a() {
                    ...
                    hn(n),
                        i.completionItems &&
                            n.push(A.Mj.registerCompletionItemProvider(t, new jt(r))),
                        i.hovers && n.push(A.Mj.registerHoverProvider(t, new Vt(r))),
                        i.documentHighlights &&
                            n.push(A.Mj.registerDocumentHighlightProvider(t, new Jt(r))),
                        i.links && n.push(A.Mj.registerLinkProvider(t, new $t(r))),
                        i.documentSymbols &&
                            n.push(A.Mj.registerDocumentSymbolProvider(t, new Yt(r))),
                        i.rename && n.push(A.Mj.registerRenameProvider(t, new tn(r))),
                        i.foldingRanges && n.push(A.Mj.registerFoldingRangeProvider(t, new rn(r))),
                        i.selectionRanges &&
                            n.push(A.Mj.registerSelectionRangeProvider(t, new on(r))),
                        i.documentFormattingEdits &&
                            n.push(A.Mj.registerDocumentFormattingEditProvider(t, new Qt(r))),
                        i.documentRangeFormattingEdits &&
                            n.push(A.Mj.registerDocumentRangeFormattingEditProvider(t, new en(r))),
                        i.diagnostics && n.push(new Ct(t, r, e));
                }
