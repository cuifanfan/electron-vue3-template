(() => {
    ...
    function f(e) {
        if (a.is(e)) {
            ...
            if (n.length > 1) throw new d(n);
            return Array.isArray(e) ? [] : e;
        }
        if (e) return h(e), e.dispose(), e;
    }
    function m(...e) {
        return e.forEach(h), g(() => f(e));
    }
    function g(e) {
        const t = c({
            dispose: () => {
    ...
    let x;
    'undefined' !== typeof I.vscode && 'undefined' !== typeof I.vscode.process
        ? (x = I.vscode.process)
        : 'undefined' !== typeof process && (x = process);
    const k =
            'string' ===
                typeof (null === (C = null === x || void 0 === x ? void 0 : x.versions) ||
                void 0 === C
                    ? void 0
                    : C.electron) && 'renderer' === x.type,
        R = k && (null === x || void 0 === x ? void 0 : x.sandboxed);
    (() => {
        if (R) return 'bypassHeatCheck';
        const e = null === x || void 0 === x ? void 0 : x.env['VSCODE_BROWSER_CODE_LOADING'];
    })();
    if ('object' !== typeof navigator || k)
        if ('object' === typeof x) {
            (N = 'win32' === x.platform),
                (E = 'darwin' === x.platform),
                (w = 'linux' === x.platform),
                (y = w && !!x.env['SNAP'] && !!x.env['SNAP_REVISION']),
                (L = b),
                (O = b);
            ...
            if (e)
                try {
                    ...
                    (L = t.locale), (O = n || b), (M = t._translationsConfigFile);
                } catch (Yn) {}
            A = !0;
    ...
    const U = N,
        D = E,
        F = (function () {
            if (I.setImmediate) return I.setImmediate.bind(I);
            if ('function' === typeof I.postMessage && !I.importScripts) {
                ...
                return (n) => {
                    const i = ++t;
                    e.push({ id: i, callback: n }), I.postMessage({ vscodeSetImmediateId: i }, '*');
                };
            }
            if ('function' === typeof (null === x || void 0 === x ? void 0 : x.nextTick))
                return x.nextTick.bind(x);
            ...
            i.then(
                ...
                (e) => {
                    e.detail instanceof Error && (e.detail = r(e.detail)),
                        this._send({ vsWorker: this._workerId, seq: n, res: void 0, err: r(e) });
                }
            );
        }
        _send(e) {
    ...
    function te(e, t) {
        t = ee(149417, t);
        for (let n = 0, i = e.length; n < i; n++) t = ee(e.charCodeAt(n), t);
        return t;
    }
    ...
    function ie(e, t = 0, n = e.byteLength, i = 0) {
        ...
        digest() {
            return (
                this._finished ||
                    ...
                    this._wrapUp()),
                se(this._h0) + se(this._h1) + se(this._h2) + se(this._h3) + se(this._h4)
            );
        }
        _wrapUp() {
            (this._buff[this._buffLen++] = 128),
                ie(this._buff, this._buffLen),
                this._buffLen > 56 && (this._step(), ie(this._buff));
        ...
        _step() {
            ...
            for (let h = 0; h < 80; h++)
                h < 20
                    ...
                    (r = (ne(s, 5) + n + u + i + e.getUint32(4 * h, !1)) & 4294967295),
                    (u = l),
                    (l = a),
                    (a = ne(o, 30)),
                    (o = s),
    ...
    function le(e, t, n) {
        return new de(new ae(e), new ae(t)).ComputeDiff(n).changes;
    }
    class ue {
        static Assert(e, t) {
    ...
    class de {
        constructor(e, t, n = null) {
            ...
            const [i, r, s] = de._getElements(e),
                [o, a, l] = de._getElements(t);
        ...
        static _getElements(e) {
            ...
            if (de._isStringArray(t)) {
                const e = new Int32Array(t.length);
                for (let n = 0, i = t.length; n < i; n++) e[n] = te(t[n], 0);
                return [t, e, !0];
            }
        ...
        WALKTRACE(e, t, n, i, r, s, o, a, l, u, h, c, d, f, m, g, _, p) {
            let C = null,
                ...
                E = d[0] - g[0] - i,
                w = -1073741824,
                y = this.m_forwardHistory.length - 1;
            do {
                const t = E + e;
                t === S || (t < N && l[t - 1] < l[t + 1])
                    ? ((h = l[t + 1]),
                      (f = h - E - i),
                      h < w && L.MarkNextChange(),
                      (w = h),
                    ...
                    : ((h = l[t - 1] + 1),
                      ...
                      (E = t - 1 - e)),
                    y >= 0 &&
                        ((l = this.m_forwardHistory[y]), (e = l[0]), (S = 1), (N = l.length - 1));
            } while (--y >= -1);
            if (((C = L.getReverseChanges()), p[0])) {
                ...
                (L = new ce()),
                    ...
                    (E = d[0] - g[0] - a),
                    (w = 1073741824),
                    (y = _ ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2);
                do {
                    const e = E + r;
                    e === S || (e < N && u[e - 1] >= u[e + 1])
                        ? ((h = u[e + 1] - 1),
            ...
            for (let E = 1; E <= f / 2 + 1; E++) {
                ...
                for (let e = u; e <= h; e += 2) {
                    (a = e === u || (e < h && g[e - 1] < g[e + 1]) ? g[e + 1] : g[e - 1] + 1),
                        (l = a - (e - p) - b);
                    const n = a;
                    while (a < t && l < i && this.ElementsAreEqual(a + 1, l + 1)) a++, l++;
                    if (
                        ((g[e] = a),
                        a + l > f + S && ((f = a), (S = l)),
                ...
                if (
                    ...
                    !this.ContinueProcessingPredicate(f, w)
                )
                    return (
                        (o[0] = !0),
                        (r[0] = f),
                ...
                if (E <= 1447) {
                    ...
                    (e[0] = p - u + 1),
                        he.Copy2(g, u, e, 1, h - u + 1),
                        this.m_forwardHistory.push(e),
                        (e = new Int32Array(d - c + 2)),
                        (e[0] = C - c + 1),
                        he.Copy2(_, c, e, 1, d - c + 1),
                        this.m_reverseHistory.push(e);
                }
            }
            return this.WALKTRACE(p, u, h, b, C, c, d, L, g, _, a, t, r, l, i, s, N, o);
        }
        PrettifyChanges(e) {
        ...
        ConcatenateChanges(e, t) {
            ...
            if (this.ChangesOverlap(e[e.length - 1], t[0], n)) {
                ...
                return (
                    he.Copy(e, 0, i, 0, e.length - 1),
                    (i[e.length - 1] = n[0]),
                    he.Copy(t, 1, i, e.length, t.length - 1),
                    i
                );
            }
            {
                const n = new Array(e.length + t.length);
                return he.Copy(e, 0, n, 0, e.length), he.Copy(t, 0, n, e.length, t.length), n;
            }
        }
    ...
    let fe;
    if ('undefined' !== typeof I.vscode && 'undefined' !== typeof I.vscode.process) {
    ...
    function ve(e, t) {
        if ('string' !== typeof e) throw new Ae(t, 'string', e);
    }
    function Te(e) {
        return e === Ne || e === Ee;
    }
            ...
            if (i(l)) {
                if (o === u - 1 || 1 === a);
                    ...
                    if (
                        r.length < 2 ||
                        2 !== s ||
                        r.charCodeAt(r.length - 1) !== Se ||
                        r.charCodeAt(r.length - 2) !== Se
                    ) {
                        if (r.length > 2) {
    ...
    function xe(e, t) {
        if (null === t || 'object' !== typeof t) throw new Ae('pathObject', 'Object', t);
    ...
    const ke = {
            resolve(...e) {
                ...
                for (let r = e.length - 1; r >= -1; r--) {
                    let s;
                    if (r >= 0) {
                        if (((s = e[r]), ve(s, 'path'), 0 === s.length)) continue;
                    } else
                        0 === t.length
                            ? (s = me())
                            : ((s = ge[`=${t}`] || me()),
                    ...
                    if (1 === o) Te(h) && ((a = 1), (u = !0));
                        ...
                        if (((u = !0), Te(s.charCodeAt(1)))) {
                            let e = 2,
                                t = e;
                            while (e < o && !Te(s.charCodeAt(e))) e++;
                            if (e < o && e !== t) {
                                const n = s.slice(t, e);
                                t = e;
                                while (e < o && Te(s.charCodeAt(e))) e++;
            ...
            normalize(e) {
                ...
                if (1 === t) return Oe(s) ? '\\' : e;
                if (Te(s))
                    if (((r = !0), Te(e.charCodeAt(1)))) {
                        let r = 2,
                            s = r;
                        while (r < t && !Te(e.charCodeAt(r))) r++;
                        if (r < t && r !== s) {
                            const o = e.slice(s, r);
                            s = r;
                            while (r < t && Te(e.charCodeAt(r))) r++;
                    ...
                    Me(s) &&
                        ...
                        ((n = e.slice(0, 2)),
                        (i = 2),
                        t > 2 && Te(e.charCodeAt(2)) && ((r = !0), (i = 3)));
                let o = i < t ? Ie(e.slice(i), !r, '\\', Te) : '';
                return (
                    0 !== o.length || r || (o = '.'),
            ...
            isAbsolute(e) {
                ...
                return Te(n) || (t > 2 && Me(n) && e.charCodeAt(1) === we && Te(e.charCodeAt(2)));
            },
            join(...e) {
                ...
                let i = !0,
                    r = 0;
                if ('string' === typeof n && Te(n.charCodeAt(0))) {
                    ++r;
                    const e = n.length;
                    e > 1 &&
                        Te(n.charCodeAt(1)) &&
                        (++r, e > 2 && (Te(n.charCodeAt(2)) ? ++r : (i = !1)));
                }
                if (i) {
                    while (r < t.length && Te(t.charCodeAt(r))) r++;
                    r >= 2 && (t = `\\${t.slice(r)}`);
                }
            ...
            relative(e, t) {
                ...
                if (d !== h) {
                    ...
                    o > h && (e.charCodeAt(r + d) === Ee ? (c = d) : 2 === d && (c = 3)),
                        -1 === c && (c = 0);
                }
                let f = '';
                for (d = r + c + 1; d <= s; ++d)
                    (d !== s && e.charCodeAt(d) !== Ee) || (f += 0 === f.length ? '..' : '\\..');
                return (
                    (a += c),
                    f.length > 0
                        ? `${f}${i.slice(a, l)}`
            ...
            toNamespacedPath(e) {
                ...
                if (t.charCodeAt(0) === Ee) {
                    if (t.charCodeAt(1) === Ee) {
                        ...
                        if (e !== ye && e !== Se) return `\\\\?\\UNC\\${t.slice(2)}`;
                    }
                } else if (Me(t.charCodeAt(0)) && t.charCodeAt(1) === we && t.charCodeAt(2) === Ee)
                    return `\\\\?\\${t}`;
                return e;
            },
            dirname(e) {
                ...
                if (1 === t) return Te(r) ? e : '.';
                if (Te(r)) {
                    if (((n = i = 1), Te(e.charCodeAt(1)))) {
                        let r = 2,
                            s = r;
                        while (r < t && !Te(e.charCodeAt(r))) r++;
                        if (r < t && r !== s) {
                    ...
                    Me(r) &&
                        e.charCodeAt(1) === we &&
                        ((n = t > 2 && Te(e.charCodeAt(2)) ? 3 : 2), (i = n));
                let s = -1,
                    o = !0;
                for (let a = t - 1; a >= i; --a)
            ...
            basename(e, t) {
                ...
                let n,
                    ...
                    s = !0;
                if (
                    (e.length >= 2 && Me(e.charCodeAt(0)) && e.charCodeAt(1) === we && (i = 2),
            ...
            extname(e) {
                ...
                let t = 0,
                    ...
                    s = !0,
                    o = 0;
                e.length >= 2 && e.charCodeAt(1) === we && Me(e.charCodeAt(0)) && (t = i = 2);
            ...
            parse(e) {
                ...
                let i = 0,
                    r = e.charCodeAt(0);
                if (1 === n) return Te(r) ? ((t.root = t.dir = e), t) : ((t.base = t.name = e), t);
                if (Te(r)) {
                    if (((i = 1), Te(e.charCodeAt(1)))) {
                        let t = 2,
                            r = t;
                        while (t < n && !Te(e.charCodeAt(t))) t++;
                        if (t < n && t !== r) {
                            r = t;
                            while (t < n && Te(e.charCodeAt(t))) t++;
                            if (t < n && t !== r) {
                ...
                } else if (Me(r) && e.charCodeAt(1) === we) {
                    if (n <= 2) return (t.root = t.dir = e), t;
                    if (((i = 2), Te(e.charCodeAt(2)))) {
        ...
        Re = {
            resolve(...e) {
                ...
                for (let i = e.length - 1; i >= -1 && !n; i--) {
                    const r = i >= 0 ? e[i] : me();
                    ve(r, 'path'),
                        0 !== r.length && ((t = `${r}/${t}`), (n = r.charCodeAt(0) === Ne));
                }
                return (t = Ie(t, !n, '/', Oe)), n ? `/${t}` : t.length > 0 ? t : '.';
            },
            normalize(e) {
                ...
                return (
                    (e = Ie(e, !t, '/', Oe)),
                    0 === e.length ? (t ? '/' : n ? './' : '.') : (n && (e += '/'), t ? `/${e}` : e)
                );
            },
            isAbsolute(e) {
                return ve(e, 'path'), e.length > 0 && e.charCodeAt(0) === Ne;
            },
            join(...e) {
                if (0 === e.length) return '.';
                let t;
                for (let n = 0; n < e.length; ++n) {
                    const i = e[n];
                    ve(i, 'path'), i.length > 0 && (void 0 === t ? (t = i) : (t += `/${i}`));
                }
                return void 0 === t ? '.' : Re.normalize(t);
            },
            relative(e, t) {
                if ((ve(e, 'from'), ve(t, 'to'), e === t)) return '';
                if (((e = Re.resolve(e)), (t = Re.resolve(t)), e === t)) return '';
                const n = 1,
                    i = e.length,
                    r = i - n,
                    s = 1,
                ...
                if (u === a)
                    if (o > a) {
                        if (t.charCodeAt(s + u) === Ne) return t.slice(s + u + 1);
                        if (0 === u) return t.slice(s + u);
                    } else r > a && (e.charCodeAt(n + u) === Ne ? (l = u) : 0 === u && (l = 0));
                let h = '';
                for (u = n + l + 1; u <= i; ++u)
                    (u !== i && e.charCodeAt(u) !== Ne) || (h += 0 === h.length ? '..' : '/..');
    ...
    (Re.win32 = ke.win32 = ke), (Re.posix = ke.posix = Re);
    'win32' === _e ? ke.normalize : Re.normalize,
        'win32' === _e ? ke.resolve : Re.resolve,
        'win32' === _e ? ke.relative : Re.relative,
        'win32' === _e ? ke.dirname : Re.dirname,
        'win32' === _e ? ke.basename : Re.basename,
        'win32' === _e ? ke.extname : Re.extname,
        'win32' === _e ? ke.sep : Re.sep;
    const Pe = /^\w[\w\d+.-]*$/,
        Ue = /^\//,
        De = /^\/\//;
    function Fe(e, t) {
    ...
    class Ve {
        constructor(e, t, n, i, r, s = !1) {
            'object' === typeof e
                ? ((this.scheme = e.scheme || We),
                  (this.authority = e.authority || We),
                  (this.path = e.path || We),
                  (this.query = e.query || We),
                  (this.fragment = e.fragment || We))
                : ((this.scheme = Ke(e, s)),
                  (this.authority = t || We),
                  (this.path = Be(this.scheme, n || We)),
                  (this.query = i || We),
                  (this.fragment = r || We),
                  Fe(this, s));
        }
        ...
        with(e) {
            ...
            return (
                void 0 === t ? (t = this.scheme) : null === t && (t = We),
                void 0 === n ? (n = this.authority) : null === n && (n = We),
                void 0 === i ? (i = this.path) : null === i && (i = We),
                void 0 === r ? (r = this.query) : null === r && (r = We),
                void 0 === s ? (s = this.fragment) : null === s && (s = We),
                t === this.scheme &&
                n === this.authority &&
                i === this.path &&
                r === this.query &&
        ...
        static parse(e, t = !1) {
            ...
            return n
                ...
                : new $e(We, We, We, We, We);
        }
        static file(e) {
            let t = We;
            if ((U && (e = e.replace(/\\/g, qe)), e[0] === qe && e[1] === qe)) {
                const n = e.indexOf(qe, 2);
                -1 === n
                    ? ((t = e.substring(2)), (e = qe))
                    : ((t = e.substring(2, n)), (e = e.substring(n) || qe));
            }
            return new $e('file', t, e, We, We);
        }
        static from(e) {
            ...
            if (e) {
                if (e instanceof Ve) return e;
                {
                    ...
                    return (
                        ...
                        (t._fsPath = e._sep === Ye ? e.fsPath : null),
                        t
                    );
                }
            }
    ...
    class $e extends Ve {
        ...
        toJSON() {
            const e = { $mid: 1 };
            return (
                this._fsPath && ((e.fsPath = this._fsPath), (e._sep = Ye)),
    ...
    function ze(e) {
        ...
        for (let n = 0; n < e.length; n++) {
            ...
            35 === i || 63 === i
                ? (void 0 === t && (t = e.substr(0, n)), (t += je[i]))
                : void 0 !== t && (t += e[n]);
        }
        return void 0 !== t ? t : e;
    }
    ...
    function Xe(e, t) {
        ...
        return a && ((i += '?'), (i += n(a, !1))), l && ((i += '#'), (i += t ? l : Ge(l, !1))), i;
    }
    function Ze(e) {
        try {
    ...
    class st {
        constructor(e) {
            const t = [],
                n = [];
            for (let i = 0, r = e.length; i < r; i++) (t[i] = ct(e[i], 1)), (n[i] = dt(e[i], 1));
    ...
    class ut {
        ...
        static createFromDiffResult(e, t, n, i, r, s, o) {
            ...
            if (
                ...
                let l = rt(s, a, r, !0).changes;
                o && (l = lt(l)), (c = []);
                for (let e = 0, t = l.length; e < t; e++)
                    c.push(at.createFromDiffChange(l[e], s, a));
            }
            return new ut(a, l, u, h, c);
        }
    }
    class ht {
        constructor(e, t, n) {
            (this.shouldComputeCharChanges = n.shouldComputeCharChanges),
                ...
                (this.continueLineDiff = ft(n.maxComputationTime)),
        ...
        _pushTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
            ...
            let a;
            this.shouldComputeCharChanges && (a = [new at(t, n, t, i, r, s, r, o)]),
                e.push(new ut(t, t, r, r, a));
        }
        _mergeTrimWhitespaceCharChange(e, t, n, i, r, s, o) {
            ...
            return (
                ...
                this.shouldComputeCharChanges &&
                    l.charChanges &&
                    l.charChanges.push(new at(t, n, t, i, r, s, r, o)),
                !0)
            );
        }
    }
    ...
    class pt {
        ...
        getAccumulatedValue(e) {
            return e < 0 ? 0 : ((e = gt(e)), this._getAccumulatedValue(e));
        }
            ...
            for (const n of t)
                this._acceptDeleteRange(n.range),
                    this._acceptInsertText(
                        new tt(n.range.startLineNumber, n.range.startColumn),
                        n.text
                    );
    ...
    function Lt(e = '') {
        let t = '(-?\\d*\\.\\d\\w*)|([^';
        for (const n of bt) e.indexOf(n) >= 0 || (t += '\\' + n);
    ...
    class At {
        constructor(e) {
            ...
            (this._defaultValue = t),
                (this._asciiMap = At._createAsciiMap(t)),
                (this._map = new Map());
        }
        ...
        static _createLink(e, t, n, i, r) {
            ...
            if (i > 0) {
                const e = t.charCodeAt(i - 1),
                    n = t.charCodeAt(s);
                ((40 === e && 41 === n) || (91 === e && 93 === n) || (123 === e && 125 === n)) &&
                    s--;
            }
            return {
                range: {
    ...
    class Dt {
        constructor() {
            (this._first = Ut.Undefined), (this._last = Ut.Undefined), (this._size = 0);
        }
        get size() {
            return this._size;
        }
        ...
        _insert(e, t) {
            const n = new Ut(e);
            if (this._first === Ut.Undefined) (this._first = n), (this._last = n);
            else if (t) {
                const e = this._last;
        ...
        _remove(e) {
            if (e.prev !== Ut.Undefined && e.next !== Ut.Undefined) {
                ...
                e.prev === Ut.Undefined && e.next === Ut.Undefined
                    ? ((this._first = Ut.Undefined), (this._last = Ut.Undefined))
                    : e.next === Ut.Undefined
                      ? ((this._last = this._last.prev), (this._last.next = Ut.Undefined))
                      : e.prev === Ut.Undefined &&
                        ((this._first = this._first.next), (this._first.prev = Ut.Undefined));
            this._size -= 1;
        }
        *[Symbol.iterator]() {
            let e = this._first;
            while (e !== Ut.Undefined) yield e.element, (e = e.next);
        }
    }
    const Ft = I.performance && 'function' === typeof I.performance.now;
    class Kt {
        constructor(e) {
            (this._highResolution = Ft && e),
    ...
    (function (e) {
        ...
        function o(...e) {
            return (t, n = null, i) => m(...e.map((e) => e((e) => t.call(n, e), null, i)));
        }
        function a(e, t, i) {
            let r = i;
        ...
        function _(e, t, n = (e) => e) {
            const i = (...e) => o.fire(n(...e)),
                ...
                o = new Vt({ onFirstListenerAdd: r, onLastListenerRemove: s });
            return o.event;
        }
    ...
    class Wt {
        constructor(e) {
            (this._listenerCount = 0),
                ...
                (this._name = `${e}_${Wt._idPool++}`);
        }
        start(e) {
            (this._stopWatch = new Kt(!0)), (this._listenerCount = e);
        }
        stop() {
            if (this._stopWatch) {
    ...
    class Ht {
        ...
        check(e) {
            let t = qt;
            if (
                ('number' === typeof this.customThreshold && (t = this.customThreshold),
                t <= 0 || e < t)
            )
                return;
            ...
            if (
                (this._stacks.set(n, i + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)
            ) {
                let n;
    ...
    class Vt {
        constructor(e) {
            ...
            (this._disposed = !1),
                (this._options = e),
                (this._leakageMon =
                    qt > 0 ? new Ht(this._options && this._options.leakWarningThreshold) : void 0),
                (this._perfMon = (
        ...
        fire(e) {
            var t, n;
            if (this._listeners) {
                this._deliveryQueue || (this._deliveryQueue = new Dt());
    ...
    Vt._noop = function () {};
    const Yt = Object.freeze(function (e, t) {
    ...
    class jt {
        ...
        get onCancellationRequested() {
            return this._isCancelled
                ? Yt
                : (this._emitter || (this._emitter = new Vt()), this._emitter.event);
        }
        dispose() {
    ...
    class Gt {
        ...
        cancel() {
            this._token
                ? this._token instanceof jt && this._token.cancel()
        ...
        dispose(e = !1) {
            e && this.cancel(),
                ...
                this._token
                    ? this._token instanceof jt && this._token.dispose()
                    : (this._token = $t.None);
        }
    }
    class zt {
    ...
    (function () {
        function e(e, t, n = t, i = n) {
            Qt.define(e, t), Xt.define(e, n), Zt.define(e, i);
        }
        e(0, 'unknown'),
            e(1, 'Backspace'),
            e(2, 'Tab'),
        ...
        (function (e) {
            ...
            function r(e) {
                return Zt.keyCodeToStr(e);
            }
            function s(e) {
                return Xt.strToKeyCode(e) || Zt.strToKeyCode(e);
            }
            (e.toString = t),
                (e.fromString = n),
    ...
    (function (e) {
        ...
        (function (e) {
            (e[(e['acceptSuggestionOnCommitCharacter'] = 0)] = 'acceptSuggestionOnCommitCharacter'),
                ...
                (e[(e['letterSpacing'] = 52)] = 'letterSpacing'),
                (e[(e['lightbulb'] = 53)] = 'lightbulb'),
                (e[(e['lineDecorationsWidth'] = 54)] = 'lineDecorationsWidth'),
                (e[(e['lineHeight'] = 55)] = 'lineHeight'),
                (e[(e['lineNumbers'] = 56)] = 'lineNumbers'),
                (e[(e['lineNumbersMinChars'] = 57)] = 'lineNumbersMinChars'),
                (e[(e['linkedEditing'] = 58)] = 'linkedEditing'),
                (e[(e['links'] = 59)] = 'links'),
                (e[(e['matchBrackets'] = 60)] = 'matchBrackets'),
                (e[(e['minimap'] = 61)] = 'minimap'),
                (e[(e['mouseStyle'] = 62)] = 'mouseStyle'),
                (e[(e['mouseWheelScrollSensitivity'] = 63)] = 'mouseWheelScrollSensitivity'),
                (e[(e['mouseWheelZoom'] = 64)] = 'mouseWheelZoom'),
                (e[(e['multiCursorMergeOverlapping'] = 65)] = 'multiCursorMergeOverlapping'),
                (e[(e['multiCursorModifier'] = 66)] = 'multiCursorModifier'),
                (e[(e['multiCursorPaste'] = 67)] = 'multiCursorPaste'),
                (e[(e['occurrencesHighlight'] = 68)] = 'occurrencesHighlight'),
                (e[(e['overviewRulerBorder'] = 69)] = 'overviewRulerBorder'),
                (e[(e['overviewRulerLanes'] = 70)] = 'overviewRulerLanes'),
                (e[(e['padding'] = 71)] = 'padding'),
                (e[(e['parameterHints'] = 72)] = 'parameterHints'),
                (e[(e['peekWidgetDefaultFocus'] = 73)] = 'peekWidgetDefaultFocus'),
                (e[(e['definitionLinkOpensInPeek'] = 74)] = 'definitionLinkOpensInPeek'),
                (e[(e['quickSuggestions'] = 75)] = 'quickSuggestions'),
                (e[(e['quickSuggestionsDelay'] = 76)] = 'quickSuggestionsDelay'),
                (e[(e['readOnly'] = 77)] = 'readOnly'),
                (e[(e['renameOnType'] = 78)] = 'renameOnType'),
                (e[(e['renderControlCharacters'] = 79)] = 'renderControlCharacters'),
                (e[(e['renderIndentGuides'] = 80)] = 'renderIndentGuides'),
                (e[(e['renderFinalNewline'] = 81)] = 'renderFinalNewline'),
                (e[(e['renderLineHighlight'] = 82)] = 'renderLineHighlight'),
                (e[(e['renderLineHighlightOnlyWhenFocus'] = 83)] =
                    'renderLineHighlightOnlyWhenFocus'),
                (e[(e['renderValidationDecorations'] = 84)] = 'renderValidationDecorations'),
                (e[(e['renderWhitespace'] = 85)] = 'renderWhitespace'),
                (e[(e['revealHorizontalRightPadding'] = 86)] = 'revealHorizontalRightPadding'),
                (e[(e['roundedSelection'] = 87)] = 'roundedSelection'),
                (e[(e['rulers'] = 88)] = 'rulers'),
                (e[(e['scrollbar'] = 89)] = 'scrollbar'),
                (e[(e['scrollBeyondLastColumn'] = 90)] = 'scrollBeyondLastColumn'),
                (e[(e['scrollBeyondLastLine'] = 91)] = 'scrollBeyondLastLine'),
                (e[(e['scrollPredominantAxis'] = 92)] = 'scrollPredominantAxis'),
                (e[(e['selectionClipboard'] = 93)] = 'selectionClipboard'),
                (e[(e['selectionHighlight'] = 94)] = 'selectionHighlight'),
                (e[(e['selectOnLineNumbers'] = 95)] = 'selectOnLineNumbers'),
                (e[(e['showFoldingControls'] = 96)] = 'showFoldingControls'),
                (e[(e['showUnused'] = 97)] = 'showUnused'),
                (e[(e['snippetSuggestions'] = 98)] = 'snippetSuggestions'),
                (e[(e['smartSelect'] = 99)] = 'smartSelect'),
                (e[(e['smoothScrolling'] = 100)] = 'smoothScrolling'),
                (e[(e['stickyTabStops'] = 101)] = 'stickyTabStops'),
                (e[(e['stopRenderingLineAfter'] = 102)] = 'stopRenderingLineAfter'),
                (e[(e['suggest'] = 103)] = 'suggest'),
                (e[(e['suggestFontSize'] = 104)] = 'suggestFontSize'),
                (e[(e['suggestLineHeight'] = 105)] = 'suggestLineHeight'),
                (e[(e['suggestOnTriggerCharacters'] = 106)] = 'suggestOnTriggerCharacters'),
                (e[(e['suggestSelection'] = 107)] = 'suggestSelection'),
                (e[(e['tabCompletion'] = 108)] = 'tabCompletion'),
                (e[(e['tabIndex'] = 109)] = 'tabIndex'),
                (e[(e['unusualLineTerminators'] = 110)] = 'unusualLineTerminators'),
                (e[(e['useShadowDOM'] = 111)] = 'useShadowDOM'),
                (e[(e['useTabStops'] = 112)] = 'useTabStops'),
                (e[(e['wordSeparators'] = 113)] = 'wordSeparators'),
                (e[(e['wordWrap'] = 114)] = 'wordWrap'),
                (e[(e['wordWrapBreakAfterCharacters'] = 115)] = 'wordWrapBreakAfterCharacters'),
                (e[(e['wordWrapBreakBeforeCharacters'] = 116)] = 'wordWrapBreakBeforeCharacters'),
                (e[(e['wordWrapColumn'] = 117)] = 'wordWrapColumn'),
                (e[(e['wordWrapOverride1'] = 118)] = 'wordWrapOverride1'),
                (e[(e['wordWrapOverride2'] = 119)] = 'wordWrapOverride2'),
                (e[(e['wrappingIndent'] = 120)] = 'wrappingIndent'),
                (e[(e['wrappingStrategy'] = 121)] = 'wrappingStrategy'),
                (e[(e['showDeprecated'] = 122)] = 'showDeprecated'),
                (e[(e['inlineHints'] = 123)] = 'inlineHints'),
                (e[(e['editorClassName'] = 124)] = 'editorClassName'),
                (e[(e['pixelRatio'] = 125)] = 'pixelRatio'),
                (e[(e['tabFocusMode'] = 126)] = 'tabFocusMode'),
                (e[(e['layoutInfo'] = 127)] = 'layoutInfo'),
                (e[(e['wrappingInfo'] = 128)] = 'wrappingInfo');
        })(cn || (cn = {})),
        (function (e) {
    ...
    (Fn.CtrlCmd = 2048), (Fn.Shift = 1024), (Fn.Alt = 512), (Fn.WinCtrl = 256);
    var Bn = function (e, t, n, i) {
        function r(e) {
    ...
    class Wn extends Ct {
        ...
        getWordAtPosition(e, t) {
            let n = wt(e.column, Nt(t), this._lines[e.lineNumber - 1], 0);
    ...
    class qn {
        ...
        acceptNewModel(e) {
            this._models[e.url] = new Wn(Ve.parse(e.url), e.lines, e.EOL, e.versionId);
        }
        ...
        navigateValueSet(e, t, n, i, r) {
            return Bn(this, void 0, void 0, function* () {
                ...
                let u = s.getValueInRange(l),
                    h = Pt.INSTANCE.navigateValueSet(t, a, l, u, n);
                return h;
            });
        }
    ...
    (qn._diffLimit = 1e5),
        ...
        'function' === typeof importScripts && (I.monaco = Kn());
    let Hn = !1;
    function Vn(e) {
        if (Hn) return;
        Hn = !0;
